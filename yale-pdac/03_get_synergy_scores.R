...
if(length(drugA_idx) > 0) {
	...
	drugA_mat$viability[which(drugA_mat$viability < 0)] <- 0
...
if(length(drugB_idx) > 0) {
	...
	drugB_mat$viability[which(drugB_mat$viability < 0)] <- 0
...
if(length(combo_idx) > 0) {
	...
	data <- list(dose.response.mats = list(block=((100-Z)/100)), drug.pairs = meta)
	...
	write.table(t(result), file=paste0("tbl.pdac.combo_summary_", idSample, "__", idDrugA, "__", idDrugB, ".txt"),
		row.names=F, col.names=F, quote=F, sep="\t")
	write.table(raw_matrix, file=paste0("tbl.pdac.raw_", idSample, "__", idDrugA, "__", idDrugB, ".txt"),
		row.names=F, col.names=F, quote=F, sep="\t")
	write.table(bliss_matrix, file=paste0("tbl.pdac.bliss_", idSample, "__", idDrugA, "__", idDrugB, ".txt"),
		row.names=F, col.names=F, quote=F, sep="\t")
	write.table(loewe_matrix, file=paste0("tbl.pdac.loewe_", idSample, "__", idDrugA, "__", idDrugB, ".txt"),
		row.names=F, col.names=F, quote=F, sep="\t")
	write.table(hsa_matrix, file=paste0("tbl.pdac.hsa_", idSample, "__", idDrugA, "__", idDrugB, ".txt"),
		row.names=F, col.names=F, quote=F, sep="\t")
	write.table(zip_matrix, file=paste0("tbl.pdac.zip_", idSample, "__", idDrugA, "__", idDrugB, ".txt"),
		row.names=F, col.names=F, quote=F, sep="\t")
